...
class Solution {
    public int lengthOfLIS(int[] nums) {
        ...
        // dp[i] = smallest possible tail of an increasing subsequence
        // of length (i + 1)
        ...
        for (int i = 1; i < nums.length; i++) {
            ...
            if (nums[i] > dp.get(dp.size() - 1)) {
                ...
                // This keeps a smaller tail for the same subsequence length.
        ...
        // Length of dp is the length of the LIS.
        return dp.size();
    }
}
```
